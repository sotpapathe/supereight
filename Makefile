...
demo-realsense:
	./build/se_apps/se-denseslam-sdf-qt --input-file realsense --volume-size 6 --init-pose 0.5,0.5,0.5 --rendering-rate 1 --compute-size-ratio 2 --integration-rate 1 --bilateral-filter
